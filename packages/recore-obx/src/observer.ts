import { Component, FunctionComponent, ComponentType } from 'react';
import { shallowEqual } from '@recore/utils/shallow-equal';

import { Reaction } from './reaction';

const SYMBOL_OBXADMIN = Symbol('__obxAdmin');
...
function defaultComponentWillUnmount(this: any) {
  this.render[SYMBOL_OBXADMIN] && this.render[SYMBOL_OBXADMIN].sleep();
...
function makeComponentReactive(this: any, render: any) {
  ...
  (reactiveRender as any)[SYMBOL_OBXADMIN] = reaction;
